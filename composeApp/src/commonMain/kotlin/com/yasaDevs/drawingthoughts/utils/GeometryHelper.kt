...
object GeometryHelper {
     ...
     */
    fun calculateOverallBounds(shapes: List<com.yasaDevs.drawingthoughts.domain.model.DrawnShape>): androidx.compose.ui.geometry.Rect? {
    ...
    fun com.yasaDevs.drawingthoughts.domain.model.DrawnShape.getBounds(): androidx.compose.ui.geometry.Rect {
        return when (this) {
            is com.yasaDevs.drawingthoughts.domain.model.DrawnShape.Geometric -> {
            ...
            is com.yasaDevs.drawingthoughts.domain.model.DrawnShape.FreeHand -> {
                var minX = Float.POSITIVE_INFINITY
                var maxX = Float.NEGATIVE_INFINITY
                var minY = Float.POSITIVE_INFINITY
                var maxY = Float.NEGATIVE_INFINITY
